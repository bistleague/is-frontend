                ...
                <v-flex xs12 md10 offset-md1 lg8 offset-lg2 xl6 offset-xl3>
                    <v-layout wrap mt-5>
                        <v-flex xs12 sm6 offset-sm3>
                            <div class="headline font-weight-bold grey--text text--darken-1">Hi, Muhammad Aditya Hilmy!</div>
                            ...
                            <v-btn color="primary" block class="text-none font-weight-bold mt-4 mb-5" @click="submit">Continue</v-btn>
                        </v-flex>
                    </v-layout>
                </v-flex>
            </v-layout>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                // TODO save and check
                // Navigate to next
                let path = this.$route.query.continue;
