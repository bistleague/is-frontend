        ...
        <v-content class="pl-3 pr-3">
            <v-layout v-if="!loading">
                <v-flex xs12 md10 offset-md1 lg8 offset-lg2 xl6 offset-xl3>
                    ...
                    <SemifinalAwait :team-name="predata.team_name" v-if="(!predata.started && !predata.stage_closed) || !predata.qualified" :qualified="predata.qualified"></SemifinalAwait>

                    <!-- Show screen if Stage is closed AND team is qualified -->
                    <SemifinalClosed v-if="predata.stage_closed && predata.qualified"></SemifinalClosed>

                    <!-- Show submission screen if Stage is started AND Stage is not closed AND team is qualified -->
                    <v-layout wrap mt-5 v-if="predata.started && !predata.stage_closed && predata.qualified">
